...
def _build_message(
    ...
    if base_name == "data-breach":
        templates = {
            "regulators": "We formally acknowledge a GDPR Article 33 notifiable personal-data breach involving approximately 50,000 records that was exposed for approximately 6 hours today. Data affected: names, email addresses, and the last four digits of payment cards. No passwords or full card numbers were exposed. The breach stemmed from a database misconfiguration, has been fully contained, remediation is complete, and customer notifications are underway. We are cooperating fully with all regulatory authorities.",
            "employees": "Today we confirmed a database misconfiguration exposed 50,000 customer records for about 6 hours. No customer passwords or full card numbers were exposed. The issue has been contained and fixed. Please do not discuss this externally until the communications team clears updates, and route all media inquiries to the communications department. Customer support staff should follow the published playbook for inquiries.",
            "customers": "We are sorry. A database misconfiguration exposed names, email addresses, and the last four digits of payment cards for 50,000 customers for approximately 6 hours today. No passwords or full card numbers were exposed. We have contained the issue, increased security monitoring, and our support team is available 24/7 to answer your questions and assist with any concerns. As a precaution, we recommend monitoring your account statements for unusual activity.",
            "press": "We confirm a contained security incident affecting 50,000 records that was exposed for approximately 6 hours due to a database misconfiguration. The exposure involved names, email addresses, and the last four digits of payment cards; it did not involve passwords or full card numbers. We have fixed the misconfiguration, notified regulators, and are contacting affected customers. We will provide timely public updates as verification completes.",
        }
